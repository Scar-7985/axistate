    ...
    const handleSubmit = () => {
        ...
        axios.post(`${POST_API}/location_highlights.php`, descData).then(resp => {
            ...
            if (jsonData.status === 100) {
                ...
                setTimeout(() => {
                    if (!updateId) {
                        navigate(`/add-sale?pageNum=5&pid=${jsonData.pid}`);
                    } else {
                        navigate(`/add-sale?pageNum=5&pid=${updatePid}`);
                    }
                }, 1000);
            } else {
            ...
            <div className="widget-box-2 mb-20 shadow">
                <h5 className="title d-flex justify-content-between align-item-center">
                    ...
                    <div className='d-flex align-items-center gap-2'>
                        <div>
                            <a className="btn-dark d-flex align-items-center gap-3" onClick={() => navigate(`/add-sale?pageNum=3&pid=${updatePid}`)}>
