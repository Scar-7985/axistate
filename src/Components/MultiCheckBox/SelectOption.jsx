...
const SelectOption = ({ Options = [], value = [], onChange, onClear, placeholder = 'Select options' }) => {
    ...
    const [expandedGroups, setExpandedGroups] = useState({}); // track expand/collapse
    ...
    const toggleGroup = (label) => {
        setExpandedGroups((prev) => ({
            ...prev,
            [label]: !prev[label], // toggle specific group
        }));
    };
    ...
    const applySelection = () => {
        ...
        Options.forEach((group) => {
            ...
            group.options.forEach((option) => {
                if (tempSelected.includes(option.value)) {
                    selectedChildren.push(option.label);
                    groupSelected = true;
                }
            });
        ...
        onChange(selectedChildren, selectedParents);
        setIsOpen(false);
    };
        ...
        <div id='searchMultiChk' ref={dropdownRef}>
            ...
            {isOpen && (
                <div className='optionBox'>
                    {Options.map((group) => (
                        <div key={group.label} className='parentChk'>
                            <div
