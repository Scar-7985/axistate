...
const AccountDetails = () => {
    ...
    useEffect(() => {
        ...
        axios.post(`${SITE_URL}/api/get-api/get-profile.php`, formData).then(resp => {
    ...
    return (
        <div className="layout-wrap">
            ...
            <header className="main-header fixed-header header-dashboard" style={{ display: "none" }}>
                        ...
                        <div className="col-lg-12">
                            <div className="inner-header">
                                <div className="inner-header-left">
                                    <div className="logo-box d-flex">
                                        <div className="logo"><a href="index.html">
                                            <img src="/assets/images/logo/logo@2x.png" alt="logo" width="174" height="44" /></a></div>
                                        ...
                                        <nav className="main-menu show navbar-expand-md">
                                            <div className="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                <ul className="navigation clearfix">
                                                    <li className="dropdown2 home"><a href="#">Home</a>
                                                        <ul>
                                                    ...
                                                    <li className="dropdown2 current"><a href="#">Dashboard</a>
                                                        <ul>
                                                            ...
                                                            <li className="current"><a href="my-profile.html">My Profile</a></li>
                                ...
                                <div className="header-account inner-header-right">
                                    <div className="box-avatar dropdown-toggle" data-bs-toggle="dropdown">
                                        <div className="avatar avt-34 round">
                                            <img src="/assets/images/avatar/avt-5.jpg" alt="avt" />
                                        </div>
                                        <p className="name">Themesflat<span className="icon icon-arr-down"></span></p>
                                        <div className="dropdown-menu">
                                            <a className="dropdown-item" href="my-favorites.html">My Properties</a>
                                            <a className="dropdown-item" href="message.html">Message</a>
                ...
                <div className="mobile-menu">
                    ...
                    <nav className="menu-box">
                        <div className="nav-logo"><a href="index.html">
                            <img src="/assets/images/logo/logo%402x.png" alt="nav-logo" width="174" height="44" /></a></div>
            ...
            <div className="sidebar-menu-dashboard" style={{ display: "none" }}>
                <a href="index.html" className="logo-box">
                    <img src="/assets/images/logo/logo-footer@2x.png" alt="" />
                </a>
                ...
                <div className="menu-box">
                    ...
                    <ul className="box-menu-dashboard">
                        <li className="nav-menu-item">
                            <a className="nav-menu-link" href="dashboard.html">
                        ...
                        <li className="nav-menu-item active">
                            <a className="nav-menu-link" href="my-profile.html">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.2">
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M10.9866 11.0056C13.3132 11.0056 15.1989 9.11897 15.1989 6.79238C15.1989 4.46579 13.3132 2.58008 10.9866 2.58008C8.66005 2.58008 6.77346 4.46579 6.77346 6.79238C6.7656 9.11111 8.6391 10.9977 10.957 11.0056H10.9866Z" stroke="#F1FAEE" strokeWidth="1.42857" strokeLinecap="round" strokeLinejoin="round" />
                                    </g>
                                </svg>
                                Profile
                            </a>
                        ...
                        <li className="nav-menu-item">
                            <a className="nav-menu-link" href="reviews.html">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.2">
                        ...
                        <li className="nav-menu-item">
                            <a className="nav-menu-link" href="message.html">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.2">
                        ...
                        <li className="nav-menu-item">
                            <a className="nav-menu-link" href="my-property.html">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.2">
                        ...
                        <li className="nav-menu-item">
                            <a className="nav-menu-link" href="my-favorites.html">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.2">
                        ...
                        <li className="nav-menu-item">
                            <a className="nav-menu-link" href="save-search.html">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.2">
                                        <circle cx="10.7864" cy="10.7864" r="8.23951" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M16.5156 16.9453L19.746 20.1673" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </g>
                                </svg>
                                Save search
                            </a>
                        ...
                        <li className="nav-menu-item">
                            <a className="nav-menu-link" href="add-property.html">
                    ...
                    <div className="widget-box-2">
                        <div className="box">
                            ...
                            <div className="box-agent-account">
                                ...
                                <a href="#" className="tf-btn primary">Remove Agent Account</a>
                            </div>
                        </div>
                        <div className="box">
                            ...
                            <div className="box-agent-avt">
                                <div className="avatar">
                                    <img src="/assets/images/avatar/account.jpg" alt="avatar" loading="lazy" width="128" height="128" />
                                </div>
                        ...
                        <div className="box">
                            ...
                            <div className="box-agent-avt">
                                <div className="img-poster">
                                    <img src="/assets/images/avatar/account-2.jpg" alt="avatar" loading="lazy" />
                                </div>
                                <div className="content uploadfile">
                        ...
                        <div className="box box-fieldset">
                            ...
                            <input type="text" value="Demo Agent" className="form-control style-1" />
                        </div>
                        <div className="box box-fieldset">
                        ...
                        <div className="box grid-4 gap-30">
                            <div className="box-fieldset">
                                ...
                                <input type="text" value="Your Company" className="form-control style-1" />
                            </div>
                            <div className="box-fieldset">
                            ...
                            <div className="box-fieldset">
                                ...
                                <input type="number" value="1332565894" className="form-control style-1" />
                            </div>
                            <div className="box-fieldset">
                                <label>Office Address:<span>*</span></label>
                                <input type="text" value="10 Bringhurst St, Houston, TX" className="form-control style-1" />
                            </div>
                        </div>
                        <div className="box grid-4 gap-30 box-info-2">
                            <div className="box-fieldset">
                                <label>Job:<span>*</span></label>
                                <input type="text" value="Realter" className="form-control style-1" />
                            </div>
                            <div className="box-fieldset">
                                <label>Email address:<span>*</span></label>
                                <input type="text" value="themeflat@gmail.com" className="form-control style-1" />
                            </div>
                            <div className="box-fieldset">
                        ...
                        <div className="box box-fieldset">
                            ...
                            <input type="text" value="634 E 236th St, Bronx, NY 10466" className="form-control style-1" />
                        </div>
                        <div className="box box-fieldset">
                            <label>Facebook:<span>*</span></label>
                            <input type="text" value="#" className="form-control style-1" />
                        </div>
                        <div className="box box-fieldset">
                        ...
                        <div className="box">
                            <a href="#" className="tf-btn primary">Save & Update</a>
                        </div>
                        ...
                        <div className="box">
                            <a href="#" className="tf-btn primary">Update Password</a>
                        </div>
                    </div>
                </div>
            </div>
